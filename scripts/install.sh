...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/hauvm/proxyipv6/main/scripts/3proxy.service --output-document=/3proxy/3proxy-0.9.4/scripts/3proxy.service2
